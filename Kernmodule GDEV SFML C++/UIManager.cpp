...
//Initializes the score and game over text
void UIManager::InitializeTexts()
{
	//ScoreText
	t_ScoreText.setFont(f_Font);
	t_ScoreText.setPosition(450.0f, 0.0f);
	...
	t_PlayerLivesText.setCharacterSize(50);
	t_PlayerLivesText.setPosition(10.0f, 840.0f);
